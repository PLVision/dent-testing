...
async def test_switching_modes_with_mac_increment(testbed):
    ...
    7. Set up streams with incremented MAC address (14000), pps 3000 and 14000 packet per burst

    9. Send traffic to rx_ports
    10. Verify all MAC entries were learnt or re-learnt on the VLAN
    11. Verify no packet loss nor packet leak occurred and all transmitted traffic received
    12. Re-initiate test params
    13.Repeat steps 5 -12 for receiving ports
