...
async def test_untagged_broadcast(testbed):
    ...
    1.Specify test data: packet to send, port settings: vla id, tagged/untagged etc.
        Port 1 vlan 2 pvid untagged
        Port 2 vlan 2 pvid untagged
        Port 3 vlan 2 pvid untagged
        Port 4 vlan 2 pvid untagged
    ...
    #  1.Specify test data: packet to send, port settings: vlan id, tagged/untagged etc.
    dts_mac = "ff:ff:ff:ff:ff:ff"
