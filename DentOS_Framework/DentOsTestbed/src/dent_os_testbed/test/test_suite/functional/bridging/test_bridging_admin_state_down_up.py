...
async def test_bridging_admin_state_down_up(testbed):
    ...
    8.  Send traffic to swp1 with source mac aa:bb:cc:dd:ee:11.
    9.  Send traffic to swp2 with source mac aa:bb:cc:dd:ee:12.
    10. Send traffic to swp3 with source mac aa:bb:cc:dd:ee:13.
    11. Send traffic to swp4 with source mac aa:bb:cc:dd:ee:14.
    12. Verify that source macs
        aa:bb:cc:dd:ee:11, aa:bb:cc:dd:ee:12, aa:bb:cc:dd:ee:13, aa:bb:cc:dd:ee:14
        haven't been learned for swp1, swp2, swp3, swp4 in accordance.

    13. Set bridge br0 admin state UP.
    14. Send traffic to swp1 with source mac aa:bb:cc:dd:ee:11.
    15. Send traffic to swp2 with source mac aa:bb:cc:dd:ee:12.
    16. Send traffic to swp3 with source mac aa:bb:cc:dd:ee:13.
    17. Send traffic to swp4 with source mac aa:bb:cc:dd:ee:14.
    18. Verify that source macs
        aa:bb:cc:dd:ee:11, aa:bb:cc:dd:ee:12, aa:bb:cc:dd:ee:13, aa:bb:cc:dd:ee:14
    ...
    for addr in test_data_in :
        assert addr not in test_data_in, f"Verify that source mac aa:bb:cc:dd:ee:11,aa:bb:cc:dd:ee:12,aa:bb:cc:dd:ee:13,aa:bb:cc:dd:ee:14 haven't been learned for swp1.\n{out}"
    ...
    for addr in test_data_out :
        assert addr in test_data_out, f"Verify that source mac aa:bb:cc:dd:ee:11,aa:bb:cc:dd:ee:12,aa:bb:cc:dd:ee:13,aa:bb:cc:dd:ee:14 have been learned for swp1.\n{out}"
