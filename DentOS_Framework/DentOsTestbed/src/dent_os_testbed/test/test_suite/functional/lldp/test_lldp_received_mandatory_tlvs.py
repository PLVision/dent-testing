...
async def test_lldp_received_mandatory_tlvs(testbed):
    """
    Test Name: test_lldp_received_mandatory_tlvs
    Test Suite: suite_functional_lldp
    Test Overview: Verify device receiving correct LLDP mandatory tlvs fields.
    ...
    7.  Verifying LLDP packet have been received on swp1 with mandatory tlvs fields.
    """
