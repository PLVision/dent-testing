...
async def test_lldp_received_optional_tlvs(testbed):
    """
    Test Name: test_lldp_received_optional_tlvs
    Test Suite: suite_functional_lldp
    Test Overview: Verify device receiving correct LLDP optional tlvs fields.
    ...
    5.  Setup LLDP packet for trasmitting to swp1.
    6.  Transmitting LLDP packet to swp1.
    7.  Verifying LLDP packet have been received on swp1 with correct optional tlvs fields.
    """
