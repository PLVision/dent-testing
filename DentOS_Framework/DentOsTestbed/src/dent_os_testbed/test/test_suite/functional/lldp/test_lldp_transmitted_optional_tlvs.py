...
async def test_lldp_transmitted_optional_tlvs(testbed):
    """
    Test Name: test_lldp_transmitted_optional_tlvs
    ...
    7.  Verifying lldp packet captured for swp1 with optional tlvs fields.
    """
