...
async def test_lldp_rx_disabled(testbed):
    """
    Test Name: test_lldp_rx_disabled
    Test Suite: suite_functional_lldp
    Test Overview: Verify that LLDP rx is disabled and no LLDP packets have been received.
