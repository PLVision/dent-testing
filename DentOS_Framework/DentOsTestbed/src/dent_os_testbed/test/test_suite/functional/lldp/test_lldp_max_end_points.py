...
async def test_lldp_max_end_points(testbed):
    """
    Test Name: test_lldp_max_end_points
    Test Suite: suite_functional_lldp
    Test Overview: Verify device receiving Max LLDP end point packets.
    ...
    5.  Setup Max end point LLDP packets for trasmitting to swp1.
    6.  Transmitting LLDP packet to swp1.
    7.  Verifying Max end point LLDP packets have been received on swp1.
    """
